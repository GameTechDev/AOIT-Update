...
{
    { _L("depthenable"),                 ePARAM_TYPE_BOOL,                  (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.DepthEnable)},
    { _L("depthwritemask"),              ePARAM_TYPE_DEPTH_WRITE_MASK,      (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.DepthWriteMask)},
    { _L("depthfunc"),                   ePARAM_TYPE_D3D11_COMPARISON_FUNC, (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.DepthFunc)},
    { _L("StencilEnable"),               ePARAM_TYPE_BOOL,                  (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.StencilEnable)},
    { _L("StencilReadMask"),             ePARAM_TYPE_UCHAR,                 (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.StencilReadMask)},
    { _L("StencilWriteMask"),            ePARAM_TYPE_UCHAR,                 (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.StencilWriteMask)},
    { _L("FrontFaceStencilFailOp"),      ePARAM_TYPE_D3D11_STENCIL_OP,      (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.FrontFace.StencilFailOp )},
    { _L("FrontFaceStencilDepthFailOp"), ePARAM_TYPE_D3D11_STENCIL_OP,      (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.FrontFace.StencilDepthFailOp)},
    { _L("FrontFaceStencilPassOp"),      ePARAM_TYPE_D3D11_STENCIL_OP,      (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.FrontFace.StencilPassOp)},
    { _L("FrontFaceStencilFunc"),        ePARAM_TYPE_D3D11_COMPARISON_FUNC, (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.FrontFace.StencilFunc)},
    { _L("BackFaceStencilFailOp"),       ePARAM_TYPE_D3D11_STENCIL_OP,      (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.BackFace.StencilFailOp)},
    { _L("BackFaceStencilDepthFailOp"),  ePARAM_TYPE_D3D11_STENCIL_OP,      (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.BackFace.StencilDepthFailOp)},
    { _L("BackFaceStencilPassOp"),       ePARAM_TYPE_D3D11_STENCIL_OP,      (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.BackFace.StencilPassOp)},
    { _L("BackFaceStencilFunc"),         ePARAM_TYPE_D3D11_COMPARISON_FUNC, (UINT)offsetof(CPUTRenderStateDX11,     DepthStencilDesc.BackFace.StencilFunc)},
    { _L("StencilRef"),                  ePARAM_TYPE_UINT,                  (UINT)offsetof(CPUTRenderStateDX11,     StencilRef )},
    { _L(""), ePARAM_TYPE_TYPELESS, 0}
};
