...
CPUTResult CPUTRenderStateBlockDX11::LoadRenderStateBlock(const cString &fileName)
{
    ...
    ReadProperties( file, _L("DepthStencilStateDX11"), pDepthStencilDescMap, &mStateDesc);
...
void CPUTRenderStateBlockDX11::SetRenderStates( CPUTRenderParameters &renderParams )
{
    ...
    pContext->OMSetDepthStencilState( mpDepthStencilState, mStateDesc.StencilRef ); // TODO: read stecil ref from config file
